async function renderAllocation(el) {
  ...
  el.innerHTML = `
    ...
    <div class="card mt" style="border-left:4px solid #ffd166">
      ...
      <div class="muted mt" style="font-size:.85em">Auto (car) liczone jako aktywo, ale to dobro konsumpcyjne (traci na wartości) — realnie „inwestycyjny" majątek jest bardziej skoncentrowany w nieruchomościach.</div>
    </div>`;
