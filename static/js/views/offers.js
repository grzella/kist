  ...
  const statsBar = s ? `
    <div class="card" style="padding:10px 16px">
      <div class="row" style="gap:22px;flex-wrap:wrap;align-items:baseline">
        <span title="Znana firma + scope ≥ Twój (senior scope) + widełki ≥ obecne. Najważniejszy sygnał rynkowy.">
  ...
  el.innerHTML = `
    ...
    <div style="margin-bottom:10px">
      <a href="#career" style="text-decoration:none;display:inline-block;padding:6px 12px;
        ...
        🧭 Analiza kariery — rozwój długoterminowy →</a>
    ...
    <div class="card" id="baroCard">
      <h3>📈 Barometr rynku — demand for tracked rolesineering (+ Twój inbound)</h3>
