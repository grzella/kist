...
async function renderMarket(el) {
  ...
  const TICKER_NAMES = {
    "AAPL": "RSU stock (ustaw ticker w RSU)",
    "GOOGL": "Alphabet Inc. (Google) — akcje z brokerage",
    "AMZN": "Amazon.com Inc. — akcje z brokerage",
    "NVDA": "NVIDIA Corporation — akcje z brokerage",
    "V": "Visa Inc. — operator kart płatniczych, akcje z brokerage",
