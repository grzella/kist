  ...
  el.innerHTML = `
    ...
    ${gh ? `<div class="card" style="border-left:4px solid #3ecf8e">
      <div class="muted" style="font-size:.85em;margin-bottom:8px">
        ...
        ${gh.github && gh.github.connected ? `<div style="font-size:.82em;margin:4px 0;padding:6px 10px;background:#4c8dff18;border-radius:6px">ℹ️ Data source: the <b>gh</b> CLI account logged in on <b>this machine</b>${gh.github.login ? ` (<a href="https://github.com/${gh.github.login}" target="_blank">@${gh.github.login}</a>)` : ""} + local git repos found here. To track <b>your</b> activity: run <code>gh auth login</code> and set <code>commit_repos</code>/<code>commit_author</code> in Settings.</div>` : ""}
